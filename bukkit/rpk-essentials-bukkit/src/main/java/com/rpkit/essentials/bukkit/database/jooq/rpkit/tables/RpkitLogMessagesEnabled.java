...
public class RpkitLogMessagesEnabled extends TableImpl<RpkitLogMessagesEnabledRecord> {
    ...
    private static final long serialVersionUID = 123038807;
     ...
     */
    public final TableField<RpkitLogMessagesEnabledRecord, Integer> ID = createField("id", org.jooq.impl.SQLDataType.INTEGER.nullable(false).identity(true), this, "");
    ...
    public List<Index> getIndexes() {
        return Arrays.<Index>asList(Indexes.RPKIT_LOG_MESSAGES_ENABLED_PRIMARY);
    }
