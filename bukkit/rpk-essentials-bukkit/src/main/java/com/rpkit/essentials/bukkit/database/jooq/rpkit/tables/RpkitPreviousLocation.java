...
public class RpkitPreviousLocation extends TableImpl<RpkitPreviousLocationRecord> {
    ...
    private static final long serialVersionUID = 1938932289;
     ...
     */
    public final TableField<RpkitPreviousLocationRecord, Integer> ID = createField("id", org.jooq.impl.SQLDataType.INTEGER.nullable(false), this, "");
     ...
     */
    public final TableField<RpkitPreviousLocationRecord, String> WORLD = createField("world", org.jooq.impl.SQLDataType.VARCHAR.length(256), this, "");
    ...
    public RpkitPreviousLocation() {
        this("rpkit_previous_location", null);
    }
    ...
    private RpkitPreviousLocation(String alias, Table<RpkitPreviousLocationRecord> aliased) {
        this(alias, aliased, null);
    }

    private RpkitPreviousLocation(String alias, Table<RpkitPreviousLocationRecord> aliased, Field<?>[] parameters) {
