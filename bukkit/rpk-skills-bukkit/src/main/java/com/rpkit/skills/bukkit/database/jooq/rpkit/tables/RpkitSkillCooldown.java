...
public class RpkitSkillCooldown extends TableImpl<RpkitSkillCooldownRecord> {
    ...
    private static final long serialVersionUID = -157655002;
     ...
     */
    public final TableField<RpkitSkillCooldownRecord, Integer> ID = createField("id", org.jooq.impl.SQLDataType.INTEGER.nullable(false), this, "");
     ...
     */
    public final TableField<RpkitSkillCooldownRecord, String> SKILL_NAME = createField("skill_name", org.jooq.impl.SQLDataType.VARCHAR.length(256), this, "");
    ...
    public RpkitSkillCooldown() {
        this("rpkit_skill_cooldown", null);
    }
    ...
    private RpkitSkillCooldown(String alias, Table<RpkitSkillCooldownRecord> aliased) {
        this(alias, aliased, null);
    }

    private RpkitSkillCooldown(String alias, Table<RpkitSkillCooldownRecord> aliased, Field<?>[] parameters) {
