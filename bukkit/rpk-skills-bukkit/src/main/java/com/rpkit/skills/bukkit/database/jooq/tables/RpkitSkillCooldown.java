...
public class RpkitSkillCooldown extends TableImpl<RpkitSkillCooldownRecord> {
    ...
    private static final long serialVersionUID = 1566182934;
     ...
     */
    public final TableField<RpkitSkillCooldownRecord, Integer> CHARACTER_ID = createField(DSL.name("character_id"), org.jooq.impl.SQLDataType.INTEGER.nullable(false), this, "");

    /**
     * The column <code>rpkit_skills.rpkit_skill_cooldown.skill_name</code>.
     */
    public final TableField<RpkitSkillCooldownRecord, String> SKILL_NAME = createField(DSL.name("skill_name"), org.jooq.impl.SQLDataType.VARCHAR(256).nullable(false), this, "");

    /**
     * The column <code>rpkit_skills.rpkit_skill_cooldown.cooldown_timestamp</code>.
     */
    public final TableField<RpkitSkillCooldownRecord, LocalDateTime> COOLDOWN_TIMESTAMP = createField(DSL.name("cooldown_timestamp"), org.jooq.impl.SQLDataType.LOCALDATETIME.nullable(false).defaultValue(DSL.field("CURRENT_TIMESTAMP", org.jooq.impl.SQLDataType.LOCALDATETIME)), this, "");
