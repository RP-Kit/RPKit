...
public class RpkitBlockInventoryChange extends TableImpl<RpkitBlockInventoryChangeRecord> {
    ...
    private static final long serialVersionUID = 243348402;
     ...
     */
    public final TableField<RpkitBlockInventoryChangeRecord, Integer> ID = createField("id", org.jooq.impl.SQLDataType.INTEGER.nullable(false), this, "");

    /**
     * The column <code>rpkit.rpkit_block_inventory_change.block_history_id</code>.
     */
    public final TableField<RpkitBlockInventoryChangeRecord, Integer> BLOCK_HISTORY_ID = createField("block_history_id", org.jooq.impl.SQLDataType.INTEGER.nullable(false), this, "");

    /**
     * The column <code>rpkit.rpkit_block_inventory_change.time</code>.
     */
    public final TableField<RpkitBlockInventoryChangeRecord, Timestamp> TIME = createField("time", org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false).defaultValue(org.jooq.impl.DSL.inline("CURRENT_TIMESTAMP", org.jooq.impl.SQLDataType.TIMESTAMP)), this, "");
     ...
     */
    public final TableField<RpkitBlockInventoryChangeRecord, byte[]> FROM = createField("from", org.jooq.impl.SQLDataType.BLOB.nullable(false), this, "");

    /**
     * The column <code>rpkit.rpkit_block_inventory_change.to</code>.
     */
    public final TableField<RpkitBlockInventoryChangeRecord, byte[]> TO = createField("to", org.jooq.impl.SQLDataType.BLOB.nullable(false), this, "");

    /**
     * The column <code>rpkit.rpkit_block_inventory_change.reason</code>.
     */
    public final TableField<RpkitBlockInventoryChangeRecord, String> REASON = createField("reason", org.jooq.impl.SQLDataType.VARCHAR.length(256).nullable(false), this, "");

    /**
     * Create a <code>rpkit.rpkit_block_inventory_change</code> table reference
     */
    public RpkitBlockInventoryChange() {
        this("rpkit_block_inventory_change", null);
    }
    ...
    private RpkitBlockInventoryChange(String alias, Table<RpkitBlockInventoryChangeRecord> aliased) {
        this(alias, aliased, null);
    }

    private RpkitBlockInventoryChange(String alias, Table<RpkitBlockInventoryChangeRecord> aliased, Field<?>[] parameters) {
