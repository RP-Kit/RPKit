...
class RPKMinecraftProfileDeleteListener(private val plugin: RPKSelectionBukkit) : Listener {
    ...
    fun onMinecraftProfileDelete(event: RPKBukkitMinecraftProfileDeleteEvent) {
        ...
        if (minecraftProfileId != null) {
            plugin.database.getTable(RPKSelectionTable::class.java).delete(minecraftProfileId)
        }
    }
