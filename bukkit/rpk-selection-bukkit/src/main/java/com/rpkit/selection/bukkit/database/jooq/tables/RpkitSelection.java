...
public class RpkitSelection extends TableImpl<RpkitSelectionRecord> {
    ...
    private static final long serialVersionUID = 1551222206;
     ...
     */
    public final TableField<RpkitSelectionRecord, Integer> MINECRAFT_PROFILE_ID = createField(DSL.name("minecraft_profile_id"), org.jooq.impl.SQLDataType.INTEGER.nullable(false), this, "");

    /**
     * The column <code>rpkit_selection.rpkit_selection.world</code>.
     */
    public final TableField<RpkitSelectionRecord, String> WORLD = createField(DSL.name("world"), org.jooq.impl.SQLDataType.VARCHAR(256).nullable(false), this, "");

    /**
     * The column <code>rpkit_selection.rpkit_selection.x_1</code>.
     */
    public final TableField<RpkitSelectionRecord, Integer> X_1 = createField(DSL.name("x_1"), org.jooq.impl.SQLDataType.INTEGER.nullable(false), this, "");

    /**
     * The column <code>rpkit_selection.rpkit_selection.y_1</code>.
     */
    public final TableField<RpkitSelectionRecord, Integer> Y_1 = createField(DSL.name("y_1"), org.jooq.impl.SQLDataType.INTEGER.nullable(false), this, "");

    /**
     * The column <code>rpkit_selection.rpkit_selection.z_1</code>.
     */
    public final TableField<RpkitSelectionRecord, Integer> Z_1 = createField(DSL.name("z_1"), org.jooq.impl.SQLDataType.INTEGER.nullable(false), this, "");

    /**
     * The column <code>rpkit_selection.rpkit_selection.x_2</code>.
     */
    public final TableField<RpkitSelectionRecord, Integer> X_2 = createField(DSL.name("x_2"), org.jooq.impl.SQLDataType.INTEGER.nullable(false), this, "");

    /**
     * The column <code>rpkit_selection.rpkit_selection.y_2</code>.
     */
    public final TableField<RpkitSelectionRecord, Integer> Y_2 = createField(DSL.name("y_2"), org.jooq.impl.SQLDataType.INTEGER.nullable(false), this, "");

    /**
     * The column <code>rpkit_selection.rpkit_selection.z_2</code>.
     */
    public final TableField<RpkitSelectionRecord, Integer> Z_2 = createField(DSL.name("z_2"), org.jooq.impl.SQLDataType.INTEGER.nullable(false), this, "");
    ...
    public List<UniqueKey<RpkitSelectionRecord>> getKeys() {
        return Arrays.<UniqueKey<RpkitSelectionRecord>>asList(Keys.KEY_RPKIT_SELECTION_PRIMARY, Keys.KEY_RPKIT_SELECTION_RPKIT_SELECTION_MINECRAFT_PROFILE_ID_UINDEX);
    }
