...
class ElysiumCharacterImpl constructor(
        ...
        gender: ElysiumGender? = plugin.core.serviceManager.getServiceProvider(ElysiumGenderProvider::class).getGender(plugin.config.getString("characters.defaults.gender")),
        age: Int = plugin.config.getInt("characters.defaults.age"),
        race: ElysiumRace? = plugin.core.serviceManager.getServiceProvider(ElysiumRaceProvider::class).getRace(plugin.config.getString("characters.defaults.race")),
