...
class ElysiumStatVariableProviderImpl(private val plugin: ElysiumStatsBukkit): ElysiumStatVariableProvider {
    ...
    override fun addStatVariable(statVariable: ElysiumStatVariable) {
    ...
    override fun removeStatVariable(statVariable: ElysiumStatVariable) {
        statVariables.remove(statVariable)
    }

    override fun getStatVariable(name: String): ElysiumStatVariable? {
