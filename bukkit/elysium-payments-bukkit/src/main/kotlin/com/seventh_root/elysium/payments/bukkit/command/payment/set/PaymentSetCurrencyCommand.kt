 ...
 */
class PaymentSetCurrencyCommand(private val plugin: ElysiumPaymentsBukkit): CommandExecutor {
    ...
    override fun onCommand(sender: CommandSender, command: Command, label: String, args: Array<out String>): Boolean {
        if (sender.hasPermission("elysium.payments.command.payment.set.currency")) {
            if (sender is Player) {
                if (args.isNotEmpty()) {
