...
public class RpkitAuction extends TableImpl<RpkitAuctionRecord> {
     ...
     */
    public final TableField<RpkitAuctionRecord, Integer> ID = createField(DSL.name("id"), org.jooq.impl.SQLDataType.INTEGER.nullable(false).identity(true), this, "");
     ...
     */
    public final TableField<RpkitAuctionRecord, Integer> CHARACTER_ID = createField(DSL.name("character_id"), org.jooq.impl.SQLDataType.INTEGER.nullable(false), this, "");

    /**
     * The column <code>rpkit_auctions.rpkit_auction.duration</code>.
     */
    public final TableField<RpkitAuctionRecord, Long> DURATION = createField(DSL.name("duration"), org.jooq.impl.SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * The column <code>rpkit_auctions.rpkit_auction.end_time</code>.
     */
    public final TableField<RpkitAuctionRecord, Long> END_TIME = createField(DSL.name("end_time"), org.jooq.impl.SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * The column <code>rpkit_auctions.rpkit_auction.start_price</code>.
     */
    public final TableField<RpkitAuctionRecord, Integer> START_PRICE = createField(DSL.name("start_price"), org.jooq.impl.SQLDataType.INTEGER.nullable(false), this, "");
     ...
     */
    public final TableField<RpkitAuctionRecord, Integer> MINIMUM_BID_INCREMENT = createField(DSL.name("minimum_bid_increment"), org.jooq.impl.SQLDataType.INTEGER.nullable(false), this, "");

    /**
     * The column <code>rpkit_auctions.rpkit_auction.bidding_open</code>.
     */
    public final TableField<RpkitAuctionRecord, Boolean> BIDDING_OPEN = createField(DSL.name("bidding_open"), org.jooq.impl.SQLDataType.BOOLEAN.nullable(false), this, "");
