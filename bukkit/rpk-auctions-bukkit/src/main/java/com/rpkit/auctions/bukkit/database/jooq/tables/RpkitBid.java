...
public class RpkitBid extends TableImpl<RpkitBidRecord> {
    ...
    private static final long serialVersionUID = -2078177251;
     ...
     */
    public final TableField<RpkitBidRecord, Integer> ID = createField(DSL.name("id"), org.jooq.impl.SQLDataType.INTEGER.nullable(false).identity(true), this, "");

    /**
     * The column <code>rpkit_auctions.rpkit_bid.auction_id</code>.
     */
    public final TableField<RpkitBidRecord, Integer> AUCTION_ID = createField(DSL.name("auction_id"), org.jooq.impl.SQLDataType.INTEGER.nullable(false), this, "");

    /**
     * The column <code>rpkit_auctions.rpkit_bid.character_id</code>.
     */
    public final TableField<RpkitBidRecord, Integer> CHARACTER_ID = createField(DSL.name("character_id"), org.jooq.impl.SQLDataType.INTEGER.nullable(false), this, "");

    /**
     * The column <code>rpkit_auctions.rpkit_bid.amount</code>.
     */
    public final TableField<RpkitBidRecord, Integer> AMOUNT = createField(DSL.name("amount"), org.jooq.impl.SQLDataType.INTEGER.nullable(false), this, "");
