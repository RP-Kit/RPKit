...
public class RpkitCharacterProfessionExperience extends TableImpl<RpkitCharacterProfessionExperienceRecord> {
    ...
    private static final long serialVersionUID = 1320621957;
     ...
     */
    public final TableField<RpkitCharacterProfessionExperienceRecord, Integer> CHARACTER_ID = createField(DSL.name("character_id"), org.jooq.impl.SQLDataType.INTEGER.nullable(false), this, "");

    /**
     * The column <code>rpkit_professions.rpkit_character_profession_experience.profession</code>.
     */
    public final TableField<RpkitCharacterProfessionExperienceRecord, String> PROFESSION = createField(DSL.name("profession"), org.jooq.impl.SQLDataType.VARCHAR(256).nullable(false), this, "");

    /**
     * The column <code>rpkit_professions.rpkit_character_profession_experience.experience</code>.
     */
    public final TableField<RpkitCharacterProfessionExperienceRecord, Integer> EXPERIENCE = createField(DSL.name("experience"), org.jooq.impl.SQLDataType.INTEGER.nullable(false), this, "");
