...
public class RpkitProfessionHidden extends TableImpl<RpkitProfessionHiddenRecord> {
    ...
    private static final long serialVersionUID = -259864048;
     ...
     */
    public final TableField<RpkitProfessionHiddenRecord, Integer> CHARACTER_ID = createField(DSL.name("character_id"), org.jooq.impl.SQLDataType.INTEGER.nullable(false), this, "");
    ...
    public List<UniqueKey<RpkitProfessionHiddenRecord>> getKeys() {
        return Arrays.<UniqueKey<RpkitProfessionHiddenRecord>>asList(Keys.KEY_RPKIT_PROFESSION_HIDDEN_PRIMARY, Keys.KEY_RPKIT_PROFESSION_HIDDEN_RPKIT_PROFESSION_HIDDEN_CHARACTER_ID_UINDEX);
    }
