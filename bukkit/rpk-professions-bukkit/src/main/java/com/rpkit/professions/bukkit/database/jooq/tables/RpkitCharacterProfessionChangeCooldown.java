...
public class RpkitCharacterProfessionChangeCooldown extends TableImpl<RpkitCharacterProfessionChangeCooldownRecord> {
    ...
    private static final long serialVersionUID = 97604565;
     ...
     */
    public final TableField<RpkitCharacterProfessionChangeCooldownRecord, Integer> CHARACTER_ID = createField(DSL.name("character_id"), org.jooq.impl.SQLDataType.INTEGER.nullable(false), this, "");

    /**
     * The column <code>rpkit_professions.rpkit_character_profession_change_cooldown.cooldown_end_time</code>.
     */
    public final TableField<RpkitCharacterProfessionChangeCooldownRecord, LocalDateTime> COOLDOWN_END_TIME = createField(DSL.name("cooldown_end_time"), org.jooq.impl.SQLDataType.LOCALDATETIME.nullable(false).defaultValue(DSL.field("CURRENT_TIMESTAMP", org.jooq.impl.SQLDataType.LOCALDATETIME)), this, "");
    ...
    public List<UniqueKey<RpkitCharacterProfessionChangeCooldownRecord>> getKeys() {
        return Arrays.<UniqueKey<RpkitCharacterProfessionChangeCooldownRecord>>asList(Keys.KEY_RPKIT_CHARACTER_PROFESSION_CHANGE_COOLDOWN_PRIMARY, Keys.KEY_RPKIT_CHARACTER_PROFESSION_CHANGE_COOLDOWN_RPKIT_CHARACTER_PROFESSION_CHANGE_COOLDOWN_CHARACTER_ID_UINDEX);
    }
