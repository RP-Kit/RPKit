...
package com.seventh_root.elysium.chat.bukkit.command.listchatchannels
...
class ListChatChannelsCommand(private val plugin: ElysiumChatBukkit): CommandExecutor {
    override fun onCommand(sender: CommandSender, command: Command, label: String, args: Array<out String>): Boolean {
        if (sender.hasPermission("elysium.chat.command.listchatchannels")) {
            ...
            plugin.core.serviceManager.getServiceProvider(ElysiumChatChannelProvider::class).chatChannels.forEach { chatChannel ->
