...
class ChatChannelSetMatchPatternCommand(private val plugin: ElysiumChatBukkit): CommandExecutor {
    ...
    override fun onCommand(sender: CommandSender, command: Command, label: String, args: Array<String>): Boolean {
        if (sender is Conversable) {
            if (sender.hasPermission("elysium.chat.command.chatchannel.set.matchpattern")) {
                ...
                sender.sendMessage(ChatColor.translateAlternateColorCodes('&', plugin.config.getString("messages.no-permission-chatchannel-set-matchpattern")))
            }
        } else {
    ...
    private inner class ChatChannelMatchPatternSetPrompt: MessagePrompt() {
        ...
        override fun getPromptText(context: ConversationContext): String {
            ...
            chatChannel.matchPattern = context.getSessionData("match_pattern") as String
