...
public class ChatChannelSetNameCommand implements CommandExecutor {

    private final ElysiumChatBukkit plugin;
    private final ConversationFactory conversationFactory;

    public ChatChannelSetNameCommand(ElysiumChatBukkit plugin) {
        this.plugin = plugin;
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        if (sender instanceof Conversable) {
            if (sender.hasPermission("elysium.chat.command.chatchannel.set.name")) {
                ...
                sender.sendMessage(ChatColor.translateAlternateColorCodes('&', plugin.getConfig().getString("messages.no-permission-chatchannel-set-name")));
            }
        } else {
    ...
    private class ChatChannelPrompt extends ValidatingPrompt {
        ...
        protected Prompt acceptValidatedInput(ConversationContext context, String input) {
            ...
            return new ChatChannelNamePrompt();
        }
    ...
    private class ChatChannelNameSetPrompt extends MessagePrompt {
        ...
        public String getPromptText(ConversationContext context) {
            ...
            chatChannel.setName((String) context.getSessionData("name"));
