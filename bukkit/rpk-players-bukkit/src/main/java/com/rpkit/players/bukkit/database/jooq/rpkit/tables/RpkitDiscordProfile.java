...
public class RpkitDiscordProfile extends TableImpl<RpkitDiscordProfileRecord> {
    ...
    private static final long serialVersionUID = 103155999;

    /**
     * The reference instance of <code>rpkit.rpkit_discord_profile</code>
     */
    ...
    /**
     * The column <code>rpkit.rpkit_discord_profile.id</code>.
     */
    public final TableField<RpkitDiscordProfileRecord, Integer> ID = createField(DSL.name("id"), org.jooq.impl.SQLDataType.INTEGER.nullable(false), this, "");

    /**
     * The column <code>rpkit.rpkit_discord_profile.profile_id</code>.
     */
    public final TableField<RpkitDiscordProfileRecord, Integer> PROFILE_ID = createField(DSL.name("profile_id"), org.jooq.impl.SQLDataType.INTEGER, this, "");

    /**
     * The column <code>rpkit.rpkit_discord_profile.discord_id</code>.
     */
    public final TableField<RpkitDiscordProfileRecord, Long> DISCORD_ID = createField(DSL.name("discord_id"), org.jooq.impl.SQLDataType.BIGINT, this, "");

    /**
     * Create a <code>rpkit.rpkit_discord_profile</code> table reference
     */
    ...
    /**
     * Create an aliased <code>rpkit.rpkit_discord_profile</code> table reference
     */
