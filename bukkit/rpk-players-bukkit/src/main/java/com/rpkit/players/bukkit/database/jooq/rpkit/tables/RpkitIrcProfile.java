...
public class RpkitIrcProfile extends TableImpl<RpkitIrcProfileRecord> {
     ...
     */
    public final TableField<RpkitIrcProfileRecord, Integer> ID = createField("id", org.jooq.impl.SQLDataType.INTEGER.nullable(false), this, "");
     ...
     */
    public final TableField<RpkitIrcProfileRecord, String> NICK = createField("nick", org.jooq.impl.SQLDataType.VARCHAR.length(256), this, "");

    /**
     * Create a <code>rpkit.rpkit_irc_profile</code> table reference
     */
    public RpkitIrcProfile() {
        this("rpkit_irc_profile", null);
    }
    ...
    private RpkitIrcProfile(String alias, Table<RpkitIrcProfileRecord> aliased) {
        this(alias, aliased, null);
    }

    private RpkitIrcProfile(String alias, Table<RpkitIrcProfileRecord> aliased, Field<?>[] parameters) {
