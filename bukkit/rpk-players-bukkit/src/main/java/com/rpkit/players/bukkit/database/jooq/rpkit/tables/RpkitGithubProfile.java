...
public class RpkitGithubProfile extends TableImpl<RpkitGithubProfileRecord> {
    ...
    private static final long serialVersionUID = 195916131;
     ...
     */
    public final TableField<RpkitGithubProfileRecord, Integer> ID = createField("id", org.jooq.impl.SQLDataType.INTEGER.nullable(false).identity(true), this, "");
     ...
     */
    public final TableField<RpkitGithubProfileRecord, String> NAME = createField("name", org.jooq.impl.SQLDataType.VARCHAR(256), this, "");

    /**
     * The column <code>rpkit.rpkit_github_profile.oauth_token</code>.
     */
    public final TableField<RpkitGithubProfileRecord, String> OAUTH_TOKEN = createField("oauth_token", org.jooq.impl.SQLDataType.VARCHAR(1024), this, "");
    ...
    public List<Index> getIndexes() {
        return Arrays.<Index>asList(Indexes.RPKIT_GITHUB_PROFILE_PRIMARY);
    }
