...
public class RpkitGithubProfile extends TableImpl<RpkitGithubProfileRecord> {
    ...
    private static final long serialVersionUID = -426085156;
     ...
     */
    public final TableField<RpkitGithubProfileRecord, Integer> PROFILE_ID = createField(DSL.name("profile_id"), org.jooq.impl.SQLDataType.INTEGER, this, "");

    /**
     * The column <code>rpkit.rpkit_github_profile.name</code>.
     */
    public final TableField<RpkitGithubProfileRecord, String> NAME = createField(DSL.name("name"), org.jooq.impl.SQLDataType.VARCHAR(256), this, "");

    /**
     * The column <code>rpkit.rpkit_github_profile.oauth_token</code>.
     */
    public final TableField<RpkitGithubProfileRecord, String> OAUTH_TOKEN = createField(DSL.name("oauth_token"), org.jooq.impl.SQLDataType.VARCHAR(1024), this, "");
