...
public class RpkitMinecraftProfile extends TableImpl<RpkitMinecraftProfileRecord> {
    ...
    private static final long serialVersionUID = -290261156;
     ...
     */
    public final TableField<RpkitMinecraftProfileRecord, Integer> ID = createField("id", org.jooq.impl.SQLDataType.INTEGER.nullable(false).identity(true), this, "");
     ...
     */
    public final TableField<RpkitMinecraftProfileRecord, String> MINECRAFT_UUID = createField("minecraft_uuid", org.jooq.impl.SQLDataType.VARCHAR(36), this, "");
    ...
    public List<Index> getIndexes() {
        return Arrays.<Index>asList(Indexes.RPKIT_MINECRAFT_PROFILE_PRIMARY);
    }
