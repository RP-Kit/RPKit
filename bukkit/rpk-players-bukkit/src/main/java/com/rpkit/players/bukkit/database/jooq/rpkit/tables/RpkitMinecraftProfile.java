...
public class RpkitMinecraftProfile extends TableImpl<RpkitMinecraftProfileRecord> {
    ...
    private static final long serialVersionUID = 1764136413;
     ...
     */
    public final TableField<RpkitMinecraftProfileRecord, Integer> PROFILE_ID = createField(DSL.name("profile_id"), org.jooq.impl.SQLDataType.INTEGER, this, "");

    /**
     * The column <code>rpkit.rpkit_minecraft_profile.minecraft_uuid</code>.
     */
    public final TableField<RpkitMinecraftProfileRecord, String> MINECRAFT_UUID = createField(DSL.name("minecraft_uuid"), org.jooq.impl.SQLDataType.VARCHAR(36), this, "");
