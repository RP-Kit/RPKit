...
public class RpkitPlayer extends TableImpl<RpkitPlayerRecord> {
     ...
     */
    public final TableField<RpkitPlayerRecord, Integer> ID = createField("id", org.jooq.impl.SQLDataType.INTEGER.nullable(false), this, "");

    /**
     * The column <code>rpkit.rpkit_player.name</code>.
     */
    public final TableField<RpkitPlayerRecord, String> NAME = createField("name", org.jooq.impl.SQLDataType.VARCHAR.length(256), this, "");

    /**
     * The column <code>rpkit.rpkit_player.minecraft_uuid</code>.
     */
    public final TableField<RpkitPlayerRecord, String> MINECRAFT_UUID = createField("minecraft_uuid", org.jooq.impl.SQLDataType.VARCHAR.length(36), this, "");

    /**
     * The column <code>rpkit.rpkit_player.irc_nick</code>.
     */
    public final TableField<RpkitPlayerRecord, String> IRC_NICK = createField("irc_nick", org.jooq.impl.SQLDataType.VARCHAR.length(256), this, "");

    /**
     * The column <code>rpkit.rpkit_player.last_known_ip</code>.
     */
    public final TableField<RpkitPlayerRecord, String> LAST_KNOWN_IP = createField("last_known_ip", org.jooq.impl.SQLDataType.VARCHAR.length(256), this, "");

    /**
     * Create a <code>rpkit.rpkit_player</code> table reference
     */
    public RpkitPlayer() {
        this("rpkit_player", null);
    }
    ...
    private RpkitPlayer(String alias, Table<RpkitPlayerRecord> aliased) {
        this(alias, aliased, null);
    }

    private RpkitPlayer(String alias, Table<RpkitPlayerRecord> aliased, Field<?>[] parameters) {
