...
public class RpkitMinecraftProfileToken extends TableImpl<RpkitMinecraftProfileTokenRecord> {
    ...
    private static final long serialVersionUID = 938925301;
     ...
     */
    public final TableField<RpkitMinecraftProfileTokenRecord, Integer> ID = createField("id", org.jooq.impl.SQLDataType.INTEGER.nullable(false).identity(true), this, "");
     ...
     */
    public final TableField<RpkitMinecraftProfileTokenRecord, String> TOKEN = createField("token", org.jooq.impl.SQLDataType.VARCHAR(36), this, "");
    ...
    public List<Index> getIndexes() {
        return Arrays.<Index>asList(Indexes.RPKIT_MINECRAFT_PROFILE_TOKEN_PRIMARY);
    }
