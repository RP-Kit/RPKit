...
data class ElysiumGroupImpl(
        ...
        override val inheritance: List<ElysiumGroup>
) : ElysiumGroup, ConfigurationSerializable {
    ...
    companion object {
        @JvmStatic
        fun deserialize(serialized: MutableMap<String, Any>): ElysiumGroupImpl {
            return ElysiumGroupImpl(
                    serialized["name"] as String,
                    serialized["allow"] as List<String>,
                    serialized["deny"] as List<String>,
                    serialized["inheritance"] as List<ElysiumGroup>
            )
        }
    }
