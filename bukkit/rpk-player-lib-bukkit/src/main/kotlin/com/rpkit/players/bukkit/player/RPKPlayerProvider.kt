...
@Deprecated("Old players API. Please move to new profiles APIs.",
        replaceWith = ReplaceWith("RPKMinecraftProfileProvider", "com.rpkit.players.bukkit.profile.RPKMinecraftProfileProvider"))
interface RPKPlayerProvider: ServiceProvider {
     ...
     */
    fun getPlayer(id: Int): RPKPlayer?
     ...
     */
    fun getPlayer(name: String): RPKPlayer?
     ...
     * @return The player
     */
    fun getPlayer(bukkitPlayer: OfflinePlayer): RPKPlayer
     ...
     * @return The player
     */
    fun getPlayer(ircUser: User): RPKPlayer
     ...
     */
    fun getPlayer(lastKnownIP: InetAddress): RPKPlayer?
     ...
     */
    fun addPlayer(player: RPKPlayer)
     ...
     */
    fun updatePlayer(player: RPKPlayer)
     ...
     */
    fun removePlayer(player: RPKPlayer)
