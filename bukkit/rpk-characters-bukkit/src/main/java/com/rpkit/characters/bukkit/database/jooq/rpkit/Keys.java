...
public class Keys {
    ...
    private static class Identities0 {
        ...
        public static Identity<RpkitNewCharacterCooldownRecord, Integer> IDENTITY_RPKIT_NEW_CHARACTER_COOLDOWN = Internal.createIdentity(RpkitNewCharacterCooldown.RPKIT_NEW_CHARACTER_COOLDOWN, RpkitNewCharacterCooldown.RPKIT_NEW_CHARACTER_COOLDOWN.ID);
