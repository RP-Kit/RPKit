...
public class RpkitNewCharacterCooldown extends TableImpl<RpkitNewCharacterCooldownRecord> {
    ...
    private static final long serialVersionUID = -2005521393;
     ...
     */
    public final TableField<RpkitNewCharacterCooldownRecord, Integer> ID = createField("id", org.jooq.impl.SQLDataType.INTEGER.nullable(false), this, "");
    ...
    public RpkitNewCharacterCooldown() {
        this("rpkit_new_character_cooldown", null);
    }
    ...
    private RpkitNewCharacterCooldown(String alias, Table<RpkitNewCharacterCooldownRecord> aliased) {
        this(alias, aliased, null);
    }

    private RpkitNewCharacterCooldown(String alias, Table<RpkitNewCharacterCooldownRecord> aliased, Field<?>[] parameters) {
