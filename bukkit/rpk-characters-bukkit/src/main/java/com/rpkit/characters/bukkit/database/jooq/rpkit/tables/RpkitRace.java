...
public class RpkitRace extends TableImpl<RpkitRaceRecord> {
    ...
    private static final long serialVersionUID = -1134791597;
     ...
     */
    public final TableField<RpkitRaceRecord, Integer> ID = createField("id", org.jooq.impl.SQLDataType.INTEGER.nullable(false).identity(true), this, "");

    /**
     * The column <code>rpkit.rpkit_race.name</code>.
     */
    public final TableField<RpkitRaceRecord, String> NAME = createField("name", org.jooq.impl.SQLDataType.VARCHAR(256), this, "");
    ...
    public List<Index> getIndexes() {
        return Arrays.<Index>asList(Indexes.RPKIT_RACE_PRIMARY);
    }
