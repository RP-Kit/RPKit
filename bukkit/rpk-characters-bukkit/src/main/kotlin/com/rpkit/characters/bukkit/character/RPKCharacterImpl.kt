                                ...
                                .forEach { field ->
                                    if (minecraftProfile.id?.value == this.minecraftProfile?.id?.value) {
                                        ...
                                        editComponent.hoverEvent = HoverEvent(
                                            ...
                                            ComponentBuilder().appendLegacy("Click to change your character's ${field.name}").create()
                                        )
                                        if (chatColor != null) {
                                        ...
                                        if (minecraftProfile.id?.value == this.minecraftProfile?.id?.value) {
                                            if (field.isHidden(this).join()) {
                                                ...
                                                unhideComponent.hoverEvent = HoverEvent(
                                                    HoverEvent.Action.SHOW_TEXT,
                                                    ComponentBuilder().appendLegacy("Click to unhide your character's ${field.name}").create()
                                                )
                                                ...
                                                hideComponent.hoverEvent = HoverEvent(
                                                    HoverEvent.Action.SHOW_TEXT,
                                                    ComponentBuilder().appendLegacy("Click to hide your character's ${field.name}").create()
                                                )
