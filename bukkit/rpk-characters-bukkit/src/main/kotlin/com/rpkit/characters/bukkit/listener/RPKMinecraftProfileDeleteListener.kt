...
class RPKMinecraftProfileDeleteListener(private val plugin: RPKCharactersBukkit) : Listener {
    ...
    fun onMinecraftProfileDelete(event: RPKBukkitMinecraftProfileDeleteEvent) {
        ...
        if (minecraftProfileId != null) {
            plugin.database.getTable(RPKCharacterTable::class.java).delete(minecraftProfileId)
        }
    }
