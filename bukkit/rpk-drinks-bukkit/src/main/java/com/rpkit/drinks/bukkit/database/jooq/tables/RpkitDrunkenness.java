...
public class RpkitDrunkenness extends TableImpl<RpkitDrunkennessRecord> {
    ...
    private static final long serialVersionUID = -397356483;
     ...
     */
    public final TableField<RpkitDrunkennessRecord, Integer> CHARACTER_ID = createField(DSL.name("character_id"), org.jooq.impl.SQLDataType.INTEGER.nullable(false), this, "");

    /**
     * The column <code>rpkit_drinks.rpkit_drunkenness.drunkenness</code>.
     */
    public final TableField<RpkitDrunkennessRecord, Integer> DRUNKENNESS = createField(DSL.name("drunkenness"), org.jooq.impl.SQLDataType.INTEGER.nullable(false), this, "");
    ...
    public List<UniqueKey<RpkitDrunkennessRecord>> getKeys() {
        return Arrays.<UniqueKey<RpkitDrunkennessRecord>>asList(Keys.KEY_RPKIT_DRUNKENNESS_PRIMARY, Keys.KEY_RPKIT_DRUNKENNESS_RPKIT_DRUNKENNESS_CHARACTER_ID_UINDEX);
    }
