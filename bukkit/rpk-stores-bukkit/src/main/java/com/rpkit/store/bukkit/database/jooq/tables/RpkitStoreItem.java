...
public class RpkitStoreItem extends TableImpl<RpkitStoreItemRecord> {
    ...
    private static final long serialVersionUID = 146020487;
     ...
     */
    public final TableField<RpkitStoreItemRecord, Integer> ID = createField(DSL.name("id"), org.jooq.impl.SQLDataType.INTEGER.nullable(false).identity(true), this, "");

    /**
     * The column <code>rpkit_stores.rpkit_store_item.plugin</code>.
     */
    public final TableField<RpkitStoreItemRecord, String> PLUGIN = createField(DSL.name("plugin"), org.jooq.impl.SQLDataType.VARCHAR(128).nullable(false), this, "");

    /**
     * The column <code>rpkit_stores.rpkit_store_item.identifier</code>.
     */
    public final TableField<RpkitStoreItemRecord, String> IDENTIFIER = createField(DSL.name("identifier"), org.jooq.impl.SQLDataType.VARCHAR(128).nullable(false), this, "");

    /**
     * The column <code>rpkit_stores.rpkit_store_item.description</code>.
     */
    public final TableField<RpkitStoreItemRecord, String> DESCRIPTION = createField(DSL.name("description"), org.jooq.impl.SQLDataType.VARCHAR(2048).nullable(false), this, "");

    /**
     * The column <code>rpkit_stores.rpkit_store_item.cost</code>.
     */
    public final TableField<RpkitStoreItemRecord, Integer> COST = createField(DSL.name("cost"), org.jooq.impl.SQLDataType.INTEGER.nullable(false), this, "");
