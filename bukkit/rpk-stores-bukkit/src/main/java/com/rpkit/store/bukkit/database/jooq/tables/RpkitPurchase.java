...
public class RpkitPurchase extends TableImpl<RpkitPurchaseRecord> {
    ...
    private static final long serialVersionUID = -171158180;
     ...
     */
    public final TableField<RpkitPurchaseRecord, LocalDateTime> PURCHASE_DATE = createField(DSL.name("purchase_date"), org.jooq.impl.SQLDataType.LOCALDATETIME.nullable(false).defaultValue(org.jooq.impl.DSL.field("current_timestamp()", org.jooq.impl.SQLDataType.LOCALDATETIME)), this, "");
