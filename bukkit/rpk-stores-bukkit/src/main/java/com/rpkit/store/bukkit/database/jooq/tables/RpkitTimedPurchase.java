...
public class RpkitTimedPurchase extends TableImpl<RpkitTimedPurchaseRecord> {
    ...
    private static final long serialVersionUID = -1554024292;
     ...
     */
    public final TableField<RpkitTimedPurchaseRecord, Integer> ID = createField(DSL.name("id"), org.jooq.impl.SQLDataType.INTEGER.nullable(false).identity(true), this, "");

    /**
     * The column <code>rpkit_stores.rpkit_timed_purchase.purchase_id</code>.
     */
    public final TableField<RpkitTimedPurchaseRecord, Integer> PURCHASE_ID = createField(DSL.name("purchase_id"), org.jooq.impl.SQLDataType.INTEGER.nullable(false), this, "");
    ...
    /**
     * Create an aliased <code>rpkit_stores.rpkit_timed_purchase</code> table reference
     */
