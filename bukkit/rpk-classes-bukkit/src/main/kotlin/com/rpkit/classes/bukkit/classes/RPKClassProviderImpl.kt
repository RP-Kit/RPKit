...
class RPKClassServiceImpl(override val plugin: RPKClassesBukkit) : RPKClassService {
    ...
    override fun getClass(character: RPKCharacter): RPKClass? {
        return plugin.database.getTable(RPKCharacterClassTable::class).get(character)?.`class`
    }
    ...
    override fun setClass(character: RPKCharacter, `class`: RPKClass) {
        ...
        if (eventOldClass != null) {
            ...
            val classExperienceTable = plugin.database.getTable(RPKClassExperienceTable::class)
        ...
        val characterClassTable = plugin.database.getTable(RPKCharacterClassTable::class)
    ...
    override fun getLevel(character: RPKCharacter, `class`: RPKClass): Int {
        val experienceService = Services[RPKExperienceService::class] ?: return 1
