...
public class RpkitClassExperience extends TableImpl<RpkitClassExperienceRecord> {
    ...
    private static final long serialVersionUID = -26994243;
     ...
     */
    public final TableField<RpkitClassExperienceRecord, Integer> ID = createField("id", org.jooq.impl.SQLDataType.INTEGER.nullable(false), this, "");
     ...
     */
    public final TableField<RpkitClassExperienceRecord, String> CLASS_NAME = createField("class_name", org.jooq.impl.SQLDataType.VARCHAR.length(256), this, "");
    ...
    public RpkitClassExperience() {
        this("rpkit_class_experience", null);
    }
    ...
    private RpkitClassExperience(String alias, Table<RpkitClassExperienceRecord> aliased) {
        this(alias, aliased, null);
    }

    private RpkitClassExperience(String alias, Table<RpkitClassExperienceRecord> aliased, Field<?>[] parameters) {
