 ...
 */
interface ElysiumPaymentGroupProvider: ServiceProvider {
     ...
     */
    val paymentGroups: List<ElysiumPaymentGroup>
     ...
     */
    fun getPaymentGroup(id: Int): ElysiumPaymentGroup?
     ...
     */
    fun getPaymentGroup(name: String): ElysiumPaymentGroup?
     ...
     */
    fun addPaymentGroup(paymentGroup: ElysiumPaymentGroup)
     ...
     */
    fun removePaymentGroup(paymentGroup: ElysiumPaymentGroup)
     ...
     */
    fun updatePaymentGroup(paymentGroup: ElysiumPaymentGroup)
