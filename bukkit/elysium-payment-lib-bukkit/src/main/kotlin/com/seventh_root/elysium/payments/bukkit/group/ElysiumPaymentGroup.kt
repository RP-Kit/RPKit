 ...
 */
interface ElysiumPaymentGroup: Entity {
     ...
     */
    val owners: List<ElysiumCharacter>
     ...
     */
    fun addOwner(character: ElysiumCharacter)
     ...
     */
    fun removeOwner(character: ElysiumCharacter)
     ...
     */
    fun addMember(character: ElysiumCharacter)
     ...
     */
    fun removeMember(character: ElysiumCharacter)
     ...
     */
    fun addInvite(character: ElysiumCharacter)
     ...
     */
    fun removeInvite(character: ElysiumCharacter)
