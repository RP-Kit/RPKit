            ...
            chatChannel.listeners.thenAccept { listeners ->
                ...
                while (matcher.find()) {
                    ...
                    if (matcher.group() == "\${channel}") {
                        ...
                        chatChannelComponent.hoverEvent = HoverEvent(HoverEvent.Action.SHOW_TEXT, ComponentBuilder("Click to talk in ${chatChannel.name.value}").create())
                        if (chatColor != null) {
                        ...
                        if (listeners.any { listenerMinecraftProfile ->
                            ...
                            muteComponent.hoverEvent = HoverEvent(HoverEvent.Action.SHOW_TEXT, ComponentBuilder("Click to mute ${chatChannel.name.value}").create())
                            if (chatColor != null) {
                            ...
                            unmuteComponent.hoverEvent = HoverEvent(HoverEvent.Action.SHOW_TEXT, ComponentBuilder("Click to unmute ${chatChannel.name.value}").create())
                            if (chatColor != null) {
