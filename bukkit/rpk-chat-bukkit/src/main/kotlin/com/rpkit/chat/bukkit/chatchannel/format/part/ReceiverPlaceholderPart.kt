...
import com.rpkit.players.bukkit.profile.minecraft.toBukkitOfflinePlayer
...
class ReceiverPlaceholderPart(
    ...
    override fun getText(context: DirectedPreFormatMessageContext): CompletableFuture<String> =
        completedFuture(PlaceholderAPI.setPlaceholders(context.receiverMinecraftProfile.toBukkitOfflinePlayer(), placeholderText))

    override fun serialize() = mutableMapOf(
        "placeholder-text" to placeholderText,
        "font" to font,
        "color" to color,
        "bold" to isBold,
        "italic" to isItalic,
    ...
    companion object {
        @JvmStatic
        fun deserialize(serialized: Map<String, Any>) = ReceiverPlaceholderPart(
            Bukkit.getPluginManager().getPlugin("rpk-chat-bukkit") as RPKChatBukkit,
            serialized["placeholder-text"] as String,
