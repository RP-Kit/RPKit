...
class SenderCharacterNamePart(
    ...
    override fun getText(context: DirectedPreFormatMessageContext) = context.senderMinecraftProfile
            ?.let { Services[RPKCharacterService::class.java]?.getPreloadedActiveCharacter(it)?.name }
            ?: ""
