...
class SenderPlaceholderPart(
    ...
    override fun getText(context: DirectedPreFormatMessageContext): CompletableFuture<String> =
        completedFuture(PlaceholderAPI.setPlaceholders(context.senderMinecraftProfile?.toBukkitOfflinePlayer(), placeholderText))
    ...
    companion object {
        @JvmStatic
        fun deserialize(serialized: Map<String, Any>) = SenderPlaceholderPart(
