...
class ReceiverCharacterCardFieldPart(
    ...
    override fun getText(context: DirectedPreFormatMessageContext): CompletableFuture<String> = CompletableFuture.supplyAsync {
        ...
        val character = characterService.getActiveCharacter(context.receiverMinecraftProfile).join() ?: return@supplyAsync ""
    ...
    companion object {
        @JvmStatic
        fun deserialize(serialized: Map<String, Any>) = ReceiverCharacterCardFieldPart(
