...
public class LastUsedChatGroup extends TableImpl<LastUsedChatGroupRecord> {
    ...
    private static final long serialVersionUID = -2110985659;
     ...
     */
    public final TableField<LastUsedChatGroupRecord, Integer> ID = createField("id", org.jooq.impl.SQLDataType.INTEGER.nullable(false), this, "");
    ...
    public LastUsedChatGroup() {
        this("last_used_chat_group", null);
    }
    ...
    private LastUsedChatGroup(String alias, Table<LastUsedChatGroupRecord> aliased) {
        this(alias, aliased, null);
    }

    private LastUsedChatGroup(String alias, Table<LastUsedChatGroupRecord> aliased, Field<?>[] parameters) {
