...
public class RpkitChatChannelMute extends TableImpl<RpkitChatChannelMuteRecord> {
    ...
    private static final long serialVersionUID = -453656397;
     ...
     */
    public final TableField<RpkitChatChannelMuteRecord, Integer> ID = createField("id", org.jooq.impl.SQLDataType.INTEGER.nullable(false), this, "");
    ...
    public RpkitChatChannelMute() {
        this("rpkit_chat_channel_mute", null);
    }
    ...
    private RpkitChatChannelMute(String alias, Table<RpkitChatChannelMuteRecord> aliased) {
        this(alias, aliased, null);
    }

    private RpkitChatChannelMute(String alias, Table<RpkitChatChannelMuteRecord> aliased, Field<?>[] parameters) {
