...
public class RpkitWalletRecord extends UpdatableRecordImpl<RpkitWalletRecord> implements Record3<Integer, Integer, Integer> {

    private static final long serialVersionUID = 1381248160;
    ...
    /**
     * Setter for <code>rpkit_economy.rpkit_wallet.currency_id</code>.
     */
    ...
    /**
     * Getter for <code>rpkit_economy.rpkit_wallet.currency_id</code>.
     */
    ...
    @Override
    public RpkitWalletRecord values(Integer value1, Integer value2, Integer value3) {
        value1(value1);
        value2(value2);
        value3(value3);
        return this;
     ...
     */
    public RpkitWalletRecord(Integer characterId, Integer currencyId, Integer balance) {
        super(RpkitWallet.RPKIT_WALLET);
