 ...
 */
class RPKWalletTable: Table<RPKWallet> {

    private val plugin: RPKEconomyBukkit
    private val cacheManager: CacheManager
    private val cache: Cache<Int, RPKWallet>
    private val characterCache: Cache<Int, MutableMap<*, *>>

    constructor(database: Database, plugin: RPKEconomyBukkit): super(database, RPKWallet::class.java) {
        this.plugin = plugin;
