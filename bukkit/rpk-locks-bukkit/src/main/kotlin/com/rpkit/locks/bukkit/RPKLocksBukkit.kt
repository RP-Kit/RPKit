...
class RPKLocksBukkit: RPKBukkitPlugin() {
    ...
    override fun setDefaultMessages() {
        core.messages.setDefault("block-locked", "&cThe \$block appears to be locked. You would need the key to get in.")
        core.messages.setDefault("crafting-no-keys", "&cYou may not use keys as a substitute for iron ingots.")
        core.messages.setDefault("keyring-invalid-item", "&cYou may not place non-key items on your keyring.")
        core.messages.setDefault("lock-successful", "&aBlock locked. You've been given the key. Please take good care of it.")
        core.messages.setDefault("lock-invalid-already-locked", "&cThat block is already locked.")
        core.messages.setDefault("unlock-successful", "&aBlock unlocked.")
        core.messages.setDefault("unlock-invalid-no-key", "&cYou must have the key to that block in order to unlock it.")
        core.messages.setDefault("unlock-invalid-not-locked", "&cThat block is not locked.")
        core.messages.setDefault("get-key-invalid-not-locked", "&cThat block is not locked.")
        core.messages.setDefault("get-key-successful", "&aHere is the key.")
        core.messages.setDefault("get-key-valid", "&aPlease interact with the block you would like the key for.")
        core.messages.setDefault("unlock-valid", "&aPlease interact with the block you would like to unlock.")
        core.messages.setDefault("not-from-console", "&cYou must be a player to perform this command.")
        core.messages.setDefault("no-character", "&cYou must have a character to perform this action.")
        core.messages.setDefault("no-permission-get-key", "&cYou do not have permission to get keys.")
        core.messages.setDefault("no-permission-keyring", "&cYou do not have permission to view your keyring.")
        core.messages.setDefault("no-permission-unlock", "&cYou do not have permission to remove locks.")
    }
