...
public class RpkitKeyring extends TableImpl<RpkitKeyringRecord> {
    ...
    private static final long serialVersionUID = -1487437573;
     ...
     */
    public final TableField<RpkitKeyringRecord, Integer> CHARACTER_ID = createField(DSL.name("character_id"), org.jooq.impl.SQLDataType.INTEGER.nullable(false), this, "");

    /**
     * The column <code>rpkit_locks.rpkit_keyring.items</code>.
     */
    public final TableField<RpkitKeyringRecord, byte[]> ITEMS = createField(DSL.name("items"), org.jooq.impl.SQLDataType.BLOB.nullable(false), this, "");
    ...
    public List<UniqueKey<RpkitKeyringRecord>> getKeys() {
        return Arrays.<UniqueKey<RpkitKeyringRecord>>asList(Keys.KEY_RPKIT_KEYRING_PRIMARY, Keys.KEY_RPKIT_KEYRING_RPKIT_KEYRING_CHARACTER_ID_UINDEX);
    }
