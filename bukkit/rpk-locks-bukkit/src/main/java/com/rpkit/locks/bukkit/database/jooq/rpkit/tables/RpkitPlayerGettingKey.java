...
public class RpkitPlayerGettingKey extends TableImpl<RpkitPlayerGettingKeyRecord> {
    ...
    private static final long serialVersionUID = -540294043;
     ...
     */
    public final TableField<RpkitPlayerGettingKeyRecord, Integer> ID = createField("id", org.jooq.impl.SQLDataType.INTEGER.nullable(false).identity(true), this, "");
    ...
    public List<Index> getIndexes() {
        return Arrays.<Index>asList(Indexes.RPKIT_PLAYER_GETTING_KEY_PRIMARY);
    }
