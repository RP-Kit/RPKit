...
public class RpkitKeyring extends TableImpl<RpkitKeyringRecord> {
    ...
    private static final long serialVersionUID = 1833996691;
     ...
     */
    public final TableField<RpkitKeyringRecord, Integer> ID = createField("id", org.jooq.impl.SQLDataType.INTEGER.nullable(false).identity(true), this, "");
    ...
    public List<Index> getIndexes() {
        return Arrays.<Index>asList(Indexes.RPKIT_KEYRING_PRIMARY);
    }
