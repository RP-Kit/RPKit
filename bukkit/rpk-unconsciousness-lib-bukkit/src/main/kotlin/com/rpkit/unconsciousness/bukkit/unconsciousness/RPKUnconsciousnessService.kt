...
interface RPKUnconsciousnessService : Service {
    ...
    fun loadUnconsciousness(character: RPKCharacter): CompletableFuture<Boolean>
    fun unloadUnconsciousness(character: RPKCharacter)
    fun getPreloadedUnconsciousness(character: RPKCharacter): Boolean
